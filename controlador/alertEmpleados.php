...
try {
    ...
    foreach ($emails as $emp) { // TODOS LOS EMAILS DE USUARIOS
      $mail->addBCC($emp[0]);
    ...
    $mail->Subject = 'Noticias empleados!!';
    $mail->Body    = 'Hola compañeros. <br/>Aqui les cuento algunas novedades: <br/>' . $comentario;
